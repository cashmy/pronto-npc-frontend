// src/components/Characters/CharactersCheckedActions.tsx (Example path)
...
// Define the props for CharactersCheckedActions
export interface CharactersCheckedActionsProps {
...
const CharactersCheckedActions: React.FC<CharactersCheckedActionsProps> = ({
  checkedRecords,
...
export default CharactersCheckedActions;
